...
struct bt_le_ext_adv_cb {
	...
	/**
	 * @brief The RPA validity of the advertising set has timed out.
	 *
	 * This callback notifies the application that the RPA validity of
	 * the advertising set has timed out. The user can use this callback
	 ...
	 */
	bool (*rpa_timed_out)(struct bt_le_ext_adv *adv);
 ...
 *
 * @retval 0 Success.
 * @retval other RPA timeout value is invalid.
 */
